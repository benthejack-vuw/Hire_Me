...
export default function velocity_pass(settings){
    ...
    const velocitiy_shader_material = new ShaderMaterial( {
      ...
      vertexShader:   velocity_shader(settings).vert,
      fragmentShader: velocity_shader(settings).frag,
    ...
    const velocity_data = initialize_random_headings(settings);
...
function initialize_random_headings(settings){
